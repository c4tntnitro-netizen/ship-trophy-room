...
// Edit this file when rewriting Isa. The hook comments map each section back
...
// hook: IsaContactDialogPlugin.showMasterwork.complete
...
// hook: IsaContactDialogPlugin.showMasterwork.incomplete
...
// hook: IsaContactDialogPlugin.showUniques.gazeUnlocked
...
// hook: IsaContactDialogPlugin.showUniques.gazeLocked
"If you ever put the Ziggurat on display, come find me. Quietly."
+ Back. -> isa_uniques

=== isa_unique_contempt_unlocked ===
// hook: IsaContactDialogPlugin.showUniques.contemptUnlocked
...
// hook: IsaContactDialogPlugin.showUniques.contemptLocked
...
+ Preview subtype comment. -> isa_subtype_comment
...
// hook: IsaContactDialogPlugin.showSubtype.unlocked
"That's enough. I can sign off on {hullmod_name}," Isa says. "Check your refit crews; the spec is in the system."
+ Back. -> isa_subtype_detail

=== isa_subtype_locked ===
// hook: IsaContactDialogPlugin.showSubtype.locked
