...
public final class GanEdenGenerator {
    ...
    private static StarSystemAPI createSystem() {
        ...
        system.setBaseName(ShipTrophyL10n.get("gan_eden_name"));
    ...
    private static void configureSystem(
        ...
        system.setName(ShipTrophyL10n.get("gan_eden_name"));
        system.setBaseName(ShipTrophyL10n.get("gan_eden_name"));
    ...
    private static PlanetAPI ensureStar(StarSystemAPI system) {
        ...
        if (star != null) {
            star.setName(ShipTrophyL10n.get("gan_eden_name"));
    ...
    private static void ensureColonizableSurfaceSites(
        ...
        ensureSurfaceSite(
                system, star, CINDERWAKE_ID,
                ShipTrophyL10n.get("gan_eden_cinderwake"),
        ...
        ensureSurfaceSite(
                system, star, RIMEWELL_ID,
                ShipTrophyL10n.get("gan_eden_rimewell"),
                RIMEWELL_SITE_TYPE,
                ...
                Conditions.RARE_ORE_ULTRARICH);
        ensureSurfaceSite(
                system, star, TREE_OF_LIFE_ID,
                ShipTrophyL10n.get("gan_eden_tree_of_life"),
        ...
        ensureSurfaceSite(
                system, star, PELAGOS_ID,
                ShipTrophyL10n.get("gan_eden_pelagos"),
                PELAGOS_SITE_TYPE,
    ...
    private static void ensureSpaceElevator(StarSystemAPI system) {
        ...
        if (elevator == null) {
            elevator = system.addCustomEntity(
                    SPACE_ELEVATOR_ID,
                    ShipTrophyL10n.get("gan_eden_space_elevator"),
                    SPACE_ELEVATOR_TYPE,
                    Factions.NEUTRAL);
        }
        if (elevator == null) return;
        elevator.setName(ShipTrophyL10n.get("gan_eden_space_elevator"));
    ...
    private static void ensureAltitudeWarning(StarSystemAPI system, PlanetAPI star) {
        ...
        RingParams params = new RingParams(width, middle, star,
                ShipTrophyL10n.get("altitude_warning_name"));
    ...
    private static void ensureConventionalHyperspaceAccess(
        ...
        if (jump == null) {
            jump = Global.getFactory().createJumpPoint(
                    HYPERSPACE_JUMP_ID,
                    ShipTrophyL10n.get("gan_eden_heavens_scar"));
            jump.setRelatedPlanet(star);
            jump.setStandardWormholeToHyperspaceVisual();
            system.addEntity(jump);
        }
        jump.setName(ShipTrophyL10n.get("gan_eden_heavens_scar"));
    ...
    private static void ensureHeavensScar(
        ...
        scar.setName(ShipTrophyL10n.get("gan_eden_heavens_scar"));
    ...
    private static void ensureArrivalRing(StarSystemAPI system, PlanetAPI star) {
        ...
        if (ring == null) {
            ring = system.addCustomEntity(
                    ARRIVAL_RING_ID,
                    ShipTrophyL10n.get("gan_eden_transit_ring"),
                    ARRIVAL_RING_TYPE,
                    Factions.NEUTRAL);
        }
        if (ring == null) return;
