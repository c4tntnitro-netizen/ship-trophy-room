...
Gan Eden is a deliberately compact, completely siloed star system built inside a prototype Dyson sphere. Its inward-facing surface uses a spherical projection of a custom 2:1 world map, so the geography itself curves and foreshortens into the circular horizon around the warm central star. Beyond the playable space, a white atmospheric haze deepens toward blue as the viewing angle approaches that inner surface. A custom annulus of solar collectors, conduits, structural ribs, and Domain-era machinery wraps around the horizon as the visible cutaway edge of the constructed shell. This **Altitude Warning** zone softly decelerates approaching fleets and rebounds them toward the star without causing hull, combat-readiness, or crew damage. Complete blackness lies outside the sphere's circular aperture.
